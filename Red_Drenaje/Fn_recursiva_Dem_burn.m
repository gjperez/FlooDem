%% Función recursiva para el Burning del Dem

function [Dem_burn,Matriz_chequeo] = Fn_recursiva_Dem_burn(Dem_burn,Red_Clasificada,Matriz_chequeo,i_aux,j_aux,Contador,Delta_caida,Clase_Principal)
Flag1=0;
while Flag1==0
    Contador=Contador+1;
    if Contador>50000
        break
            ...
            if Red_Clasificada(i_aux-1,j_aux+1)==Clase_Principal && Matriz_chequeo(i_aux-1,j_aux+1)==0
                ...
                [Dem_burn,Matriz_chequeo] = Fn_recursiva_Dem_burn(Dem_burn,Red_Clasificada,Matriz_chequeo,i_aux,j_aux,Contador,Delta_caida,Clase_Principal);
